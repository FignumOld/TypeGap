...
namespace TypeLite.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        {
            return type.GetDnxCompatible().GetCustomAttributes(typeof(TType), inherit).FirstOrDefault() as TType;
        }
        ...
        {
            return type.GetDnxCompatible().IsGenericType && type.GetGenericTypeDefinition() == typeof(Nullable<>);
        }
        ...
        {
            return type.GetDnxCompatible().IsInterface;
        }

#if NETSTANDARD1_6
        public static TypeInfo GetDnxCompatible(this Type type)
        {
            return type.GetTypeInfo();
        }
#else
        public static Type GetDnxCompatible(this Type type)
        {
            return type;
        }
#endif
